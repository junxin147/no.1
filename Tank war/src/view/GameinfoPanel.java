 ...
 * @Description: TODO(游戏信息面板) 
 * @author 
 *
 */
public class GameinfoPanel extends JPanel {
	private JLabel tankinfo=new JLabel("敌方坦克还有:");
	...
	private JLabel helpinfo=new JLabel("<html>游戏玩法<br>向上：W<br>向下：S<br>向左：A<br>向右：D<br>发射:J<br>暂停：P<br>继续：C");
	private JLabel nameinfo=new JLabel("玩家名字：");
	private JLabel destroyinfo=new JLabel("该关击毁坦克：");
	private JLabel scoreinfo=new JLabel("该关得分：");
